...
#define EXAMPLE_DEVICE_NAME "ESP32_Daniel"
...
//Agregamos algunas variables y estados.
...
static void esp_spp_cb(esp_spp_cb_event_t event, esp_spp_cb_param_t *param)
{
    ...
    case ESP_SPP_INIT_EVT:
        if (param->init.status == ESP_SPP_SUCCESS) {
            ...
            ESP_LOGI(SPP_TAG, "Nombre del dispositivo: %s", EXAMPLE_DEVICE_NAME);
        } else {
    ...
    //==================================Agregamos esto=================================
            ...
            esp_log_buffer_char("Mensaje recibido: ", param->data_ind.data, param->data_ind.len); //Agregado
        }
...
void app_main(void)
{
    ...
    /*
    Inicializamos UART para realizar la captura de datos
    */
    uartInit(PC_UART_PORT, UARTS_BAUD_RATE, 8, 0, 0, PC_UART_TX_PIN, PC_UART_RX_PIN);
